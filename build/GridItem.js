...
var GridItem = /*#__PURE__*/function (_React$Component) {
  ...
  function GridItem() {
    ...
    , _ref) {
      ...
      var _calcXY = (0, _calculateUtils.calcXY)(_this.getPositionParams(), newPosition.top, newPosition.left, _this.props.w, _this.props.h, _this.props.lockedRatio),
          x = _calcXY.x,
          y = _calcXY.y;
    ...
    , _ref2) {
      ...
      var _calcXY2 = (0, _calculateUtils.calcXY)(_this.getPositionParams(), newPosition.top, newPosition.left, _this.props.w, _this.props.h, _this.props.lockedRatio),
          x = _calcXY2.x,
          y = _calcXY2.y;
    ...
    , _ref3) {
      ...
      var _calcXY3 = (0, _calculateUtils.calcXY)(_this.getPositionParams(), newPosition.top, newPosition.left, _this.props.w, _this.props.h, _this.props.lockedRatio),
          x = _calcXY3.x,
          y = _calcXY3.y;
  ...
  _createClass(GridItem, [{
    ...
    /*: State*/
      ...
      var oldPosition = (0, _calculateUtils.calcGridItemPosition)(this.getPositionParams(this.props), this.props.x, this.props.y, this.props.w, this.props.h, this.props.lockedRatio, this.state);
      var newPosition = (0, _calculateUtils.calcGridItemPosition)(this.getPositionParams(nextProps), nextProps.x, nextProps.y, nextProps.w, nextProps.h, this.props.lockedRatio, nextState);
    ...
    /*: ReactElement<any>*/
    {
      var _this$props3 = this.props,
          ...
          lockedRatio = _this$props3.lockedRatio;
      ...
      var maxWidth = (0, _calculateUtils.calcGridItemPosition)(positionParams, 0, 0, cols - x, 0, lockedRatio).width; // Calculate min/max constraints using our min & maxes

      var mins = (0, _calculateUtils.calcGridItemPosition)(positionParams, 0, 0, minW, minH, lockedRatio);
      var maxes = (0, _calculateUtils.calcGridItemPosition)(positionParams, 0, 0, maxW, maxH, lockedRatio);
    ...
    /*: string*/
      ...
      var _this$props4 = this.props,
          ...
          lockedRatio = _this$props4.lockedRatio; // Get new XY

      var _calcWH = (0, _calculateUtils.calcWH)(this.getPositionParams(), size.width, size.height, x, y, lockedRatio),
          w = _calcWH.w,
    ...
    /*: ReactNode*/
    {
      var _this$props5 = this.props,
          ...
          lockedRatio = _this$props5.lockedRatio;
      var pos = (0, _calculateUtils.calcGridItemPosition)(this.getPositionParams(), x, y, w, h, lockedRatio, this.state);
...
_defineProperty(GridItem, "propTypes", {
  ...
  // Axiom:
  lockedRatio: _propTypes.default.number.isRequired,
