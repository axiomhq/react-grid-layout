...
var ReactGridLayout = /*#__PURE__*/function (_React$Component) {
  ...
  /*: void*/
  {
    ...
    /*: DragOverEvent*/
      ...
      var _this$props = _this.props,
          ...
          lockedRatio = _this$props.lockedRatio;
      ...
      if (!_this.state.droppingDOMNode) {
        ...
        var calculatedPosition = (0, _calculateUtils.calcXY)(positionParams, layerY, layerX, droppingItem.w, droppingItem.h, lockedRatio);
  ...
  _createClass(ReactGridLayout, [{
    ...
    value: function containerHeight() {
      ...
      var rowHeight = this.props.lockedRatio ? this.state.colWidth / this.props.lockedRatio : this.props.rowHeight;
    ...
    /*: ?ReactElement<any>*/
    {
      ...
      var _this$props5 = this.props,
          ...
          lockedRatio = _this$props5.lockedRatio; // {...this.state.activeDrag} is pretty slow, actually
    ...
    /*: ?ReactElement<any>*/
    {
      ...
      var _this$props6 = this.props,
          ...
          lockedRatio = _this$props6.lockedRatio;
    ...
    /*: State*/
      ...
      var newLayoutBase; // Axiom:

      var newColWidth = null;

      if (nextProps.lockedRatio) {
        if (!(0, _lodash.default)(nextProps.width, prevState.width)) {
