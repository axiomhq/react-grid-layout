...
var ReactGridLayout = (function(_React$Component) {
  ...
  ReactGridLayout.prototype.UNSAFE_componentWillReceiveProps = function UNSAFE_componentWillReceiveProps(
    ...
    if (this.props.lockedRatio) {
      if (!(0, _lodash2.default)(nextProps.width, this.props.width)) {
        var _props = this.props,
          _cols = _props.cols,
          _margin = _props.margin,
          _containerPadding = _props.containerPadding;

        var gridItemContainerPadding = _containerPadding || _margin;
        var _colWidth =
          (nextProps.width -
            _margin[0] * (_cols - 1) -
  ...
  ReactGridLayout.prototype.containerHeight = function containerHeight() {
    ...
    var rowHeight = this.props.lockedRatio
