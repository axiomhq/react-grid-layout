    ...
    function(t, e, n) {
      ...
      (f.displayName = "ReactGridLayout"),
        (f.propTypes = {
          ...
          fontSizeRatio: a.default.number,
	...
	*/
    ...
    function(t, e, n) {
        ...
        return (
          ...
          (e.prototype.calcPosition = function(t, e, n, r, o) {
            ...
            if (l) {
              var p = c / l,
                h = p * l;
              (f.left = Math.round((h + i[0]) * t + s[0])),
                (f.top = Math.round((p + i[1]) * e + s[1])),
                (f.width =
                  n === 1 / 0
                    ? n
                ...
                (f.height =
                  r === 1 / 0
                    ? r
                    : Math.round(p * r + Math.max(0, r - 1) * i[1]));
            } else
              (f.left = Math.round((c + i[0]) * t + s[0])),
                (f.top = Math.round((u + i[1]) * e + s[1])),
                (f.width =
                  n === 1 / 0
                    ? n
          ...
          (e.prototype.calcXY = function(t, e) {
            ...
            if (l) {
              var h = c / l,
                d = h * l;
              (f = Math.round((e - r[0]) / (d + r[0]))),
                (p = Math.round((t - r[1]) / (h + r[1])));
            } else
              (f = Math.round((e - r[0]) / (c + r[0]))),
                (p = Math.round((t - r[1]) / (a + r[1])));
            return {
              x: (f = Math.max(Math.min(f, o - i), 0)),
          ...
          (e.prototype.createStyle = function(t) {
            ...
            return (
              o
                ? (s = (0, u.setTransform)(t))
                : ((s = (0, u.setTopLeft)(t)),
                  n &&
                    ((s.left = (0, u.perc)(t.left / r)),
                    (s.width = (0, u.perc)(t.width / r)))),
              a &&
                (s.fontSize =
                  Math.round(Math.min(t.width, t.height) * i) + "px"),
              s
            );
          }),
      ...
      (p.propTypes = {
        ...
        fontSizeRatio: a.default.number.isRequired,
