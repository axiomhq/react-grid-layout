    ...
    function(t, e, n) {
      (function(t, n) {
        ...
        (C["[object Float32Array]"] = C["[object Float64Array]"] = C[
          ...
          (C[u] = C[l] = C[z] = C[p] = C[j] = C[f] = C[h] = C[d] = C[g] = C[
            m
          ] = C[b] = C[x] = C[S] = C[R] = C["[object WeakMap]"] = !1);
        var E = "object" == typeof t && t && t.Object === Object && t,
          T = "object" == typeof self && self && self.Object === Object && self,
          M = E || T || Function("return this")(),
          P = e && !e.nodeType && e,
        ...
        function Mt(t) {
          return (
            !(!$t(t) || ((e = t), Q && Q in e)) && (Gt(t) ? tt : k).test(qt(t))
          );
          var e;
        }
        function Pt(t) {
        ...
        function Qt(t) {
          return null != (e = t) && Vt(e.length) && !Gt(e) ? kt(t) : Pt(t);
          var e;
        }
        ...
        return (
          ...
          (e.prototype.UNSAFE_componentWillReceiveProps = function(t) {
            ...
            if (
              ...
              !(0, i.default)(t.width, this.props.width)
            ) {
              var o = this.props,
                a = o.cols,
                s = o.margin,
                l = o.containerPadding || s,
                c = (t.width - s[0] * (a - 1) - 2 * l[0]) / a;
              this.setState({ colWidth: c });
            }
          }),
          (e.prototype.containerHeight = function() {
            if (this.props.autoSize) {
              var t = this.props.lockedRatio
                  ? this.state.colWidth / this.props.lockedRatio
                  : this.props.rowHeight,
                e = (0, u.bottom)(this.state.layout),
                n = this.props.containerPadding
                  ? this.props.containerPadding[1]
                  : this.props.margin[1];
              return (
                Math.ceil(e * t + (e - 1) * this.props.margin[1] + 2 * n) + "px"
              );
            }
          }),
...
*/
	...
	*/
        ...
        var D = (function() {
            ...
            if (t in e) return "";
            for (var n = 0; n < j.length; n++) if (k(t, j[n]) in e) return j[n];
            return "";
          })(),
          C = function(t, e) {
            if (!(t instanceof e))
        ...
        return (
          ...
          (at.defaultProps = M({}, ot.defaultProps, {
            axis: "both",
            bounds: !1,
    ...
    function(t, e, n) {
        ...
        return (
          ...
          (e.prototype.calcPosition = function(t, e, n, r, o) {
            ...
            if (l) {
              var f = c / l,
                h = f * l;
              (p.left = Math.round((h + i[0]) * t + s[0])),
                (p.top = Math.round((f + i[1]) * e + s[1])),
                (p.width =
                  n === 1 / 0
                    ? n
                    : Math.round(h * n + Math.max(0, n - 1) * i[0])),
                (p.height =
                  r === 1 / 0
                    ? r
                    : Math.round(f * r + Math.max(0, r - 1) * i[1]));
            } else
              (p.left = Math.round((c + i[0]) * t + s[0])),
                (p.top = Math.round((u + i[1]) * e + s[1])),
                (p.width =
                  n === 1 / 0
                    ? n
                    : Math.round(c * n + Math.max(0, n - 1) * i[0])),
                (p.height =
                  r === 1 / 0
                    ? r
            ...
            return (
              o &&
                o.resizing &&
                ((p.width = Math.round(o.resizing.width)),
                (p.height = Math.round(o.resizing.height))),
              o &&
                o.dragging &&
                ((p.top = Math.round(o.dragging.top)),
                (p.left = Math.round(o.dragging.left))),
              p
            );
          }),
          (e.prototype.calcXY = function(t, e) {
            ...
            if (l) {
              var h = c / l,
                d = h * l;
              (p = Math.round((e - r[0]) / (d + r[0]))),
                (f = Math.round((t - r[1]) / (h + r[1])));
            } else
              (p = Math.round((e - r[0]) / (c + r[0]))),
                (f = Math.round((t - r[1]) / (a + r[1])));
            return {
              x: (p = Math.max(Math.min(p, o - i), 0)),
          ...
          (e.prototype.calcWH = function(t) {
            ...
            if (c) {
              var d = p / c,
                y = d * c;
              (f = Math.round((n + o[0]) / (y + o[0]))),
                (h = Math.round((e + o[1]) / (d + o[1])));
            } else
              (f = Math.round((n + o[0]) / (p + o[0]))),
      ...
      (f.propTypes = {
        ...
        lockedRatio: a.default.number.isRequired,
